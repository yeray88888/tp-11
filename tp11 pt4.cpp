...
void buscarAlumno(const vector<Alumno>& alumnos, const string& nombreBuscado) {
    ...
    for (size_t i = 0; i < alumnos.size(); i++) {
        ...
        if (alumno.getNombre() == nombreBuscado) {
            ...
            cout << "Nota más alta: " << alumno.getNotaMasAlta() << endl; // Mostrar nota más alta
            cout << "Nota más baja: " << alumno.getNotaMasBaja() << endl; // Mostrar nota más baja
            encontrado = true;
            break; 
        }
    }
...
int main() {
    ...
    for (size_t i = 0; i < alumnos.size(); i++) {
        ...
        cout << "Nota más alta: " << alumno.getNotaMasAlta() << endl; 
        cout << "Nota más baja: " << alumno.getNotaMasBaja() << endl; 
        cout << endl;
    }
